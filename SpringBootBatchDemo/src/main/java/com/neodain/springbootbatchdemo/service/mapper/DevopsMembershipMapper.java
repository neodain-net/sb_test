...
public class DevopsMembershipMapper {
  ...
  // DTO → Entity 변환
  public static DevopsMembership toEntity(MembershipRequest request, IDevopsMemberRepository memberRepository, IDevopsRepository devopsRepository) {
